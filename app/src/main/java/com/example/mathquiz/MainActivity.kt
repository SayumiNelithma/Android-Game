...
class MainActivity : ComponentActivity() {
    ...
    // Variable to hold the selected operation
    private var selectedOperation: Int = ADDITION  // Default to ADDITION

    // Constant variables representing different math operations
    companion object {
    ...
    // Colors for correct and incorrect answer backgrounds
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Define a click listener for the exit button
        val exitClickListener = View.OnClickListener {
            // Create an AlertDialog to confirm app exit
        ...
        // Find various UI elements from the layout XML and assign them to variables
        ...
        // Hide the gamelayout initially
        gamelayout.visibility = View.GONE

        //to start the game timer
        startButton.setOnClickListener {

            // Initialize and start a CountDownTimer for game duration
            ...
            object : CountDownTimer(durationInMillis, intervalInMillis) {
                ...
                override fun onFinish() {
                    timerTextView.text = "0" // Update timer text when timer finishes
                }
            }.start() // Start the CountDownTimer
        }


        // Find other UI elements and set click listeners for game operations and options
        ...
        // Change status bar color to a specific color code
